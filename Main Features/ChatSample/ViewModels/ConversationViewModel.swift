  ...
  init() {
    ...
    chat = model.startChat(history: [
        ModelContent(
          role: "user",
          parts: [
            .text("You are an advanced AI assistant specializing in agriculture, tasked with answering questions asked by farmers to help deal with pest infestations and offer actionable advice. Your response should directly and concisely answer the question and help farmers make informed decisions to effectively manage agricultural issues for efficient and sustainable farming.")
          ]
        )
      ])
  }
