...
var mlModel = try! PestDetection(configuration: .init()).model
...
class ViewController: UIViewController {
    ...
    @IBAction func indexChanged(_ sender: Any) {
        ...
        case 0:
            self.labelName.text = "Pest"
            mlModel = try! PestDetection(configuration: .init()).model
        case 1:
            self.labelName.text = "Beta"
            mlModel = try! PestDetection(configuration: .init()).model
        case 2:
            self.labelName.text = "General"
            mlModel = try! PestDetection(configuration: .init()).model
        default:
            break
        }
    ...
    func setLabels() {
        self.labelName.text = "Pest Detection"
    }
